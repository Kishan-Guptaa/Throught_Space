...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Welcome back to ThoughtSpace!");
      router.push("/");
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#111111] flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-gray-100 dark:bg-gray-900/50 rounded-full blur-[120px] opacity-50" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-gray-100 dark:bg-gray-900/50 rounded-full blur-[120px] opacity-50" />
      </div>
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="mt-6 text-3xl font-black text-gray-900 dark:text-gray-100 font-serif">Welcome Back</h2>
          <p className="mt-2 text-gray-500 font-medium">Continue your journey of inspiration.</p>
        </div>
        ...
        <div className="bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-gray-800 rounded-[2.5rem] p-8 md:p-10 shadow-2xl shadow-black/5">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              <Link href="/forgot-password" id="forgot-password-link" className="text-sm font-bold text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest font-black">
              <span className="bg-white dark:bg-[#1A1A1A] px-4 text-gray-400">Or continue with</span>
            </div>
          </div>
        ...
        <p className="mt-8 text-center text-gray-500 font-medium">
          ...
          <Link href="/signup" className="text-gray-900 dark:text-white font-black underline underline-offset-4">
            Sign up for free
          </Link>
        </p>
      </div>
